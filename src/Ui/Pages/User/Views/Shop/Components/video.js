...
import { getVideo } from "../../../../../../Domain/Repositories/Firebase/Crud/read";
              ...
              <View style={{flex:1, flexDirection: "column", backgroundColor: "#235b76"}}>
                ...
                <TouchableOpacity>
                  ...
                  <View style={{flex:1, alignContent:"center", alignItems: "center"}}>
                    ...
                    <Text>{data.item.gpu}</Text>
                    <Text>{data.item.imageurl}</Text>
                    <Text>{data.item.memory}</Text>
                    <Text>{data.item.name}</Text>
                    <Text>{data.item.producer}</Text>
                  </View>
